...
func jsonResponse(w http.ResponseWriter, statusCode int, data any) {
	...
	if statusCode != http.StatusOK {
		w.WriteHeader(statusCode)
		log.Println(statusCode, string(jsonResponseObj))
	}
...
// # getRequestSenderIDfromcookie gets the ID of the request sender from the cookie
//
// @r.params Cookie: user_uuid
//
// @depends {getRequestSenderIDfromcookie -> getIDbyUUID}
func getRequestSenderIDfromcookie(r *http.Request) (int, error) {
